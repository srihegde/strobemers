...
# do
# 	# mummer MEM
# 	/usr/bin/time -p mummer -F -maxmatch -l $k -b  $genome1 $genome2 > tmp.tsv 2> runtime.txt
# 	echo -n "MUMmer & MEM & " $k " & " 
...
# 	exit
# 	# # mummer MUM
# 	/usr/bin/time mummer -F -l $k -mum -b $genome1 $genome2 > tmp.tsv 2> runtime.txt
# 	echo -n "MUMmer & MUM & " $k " & " 
...
/usr/bin/time -f $TIME_FORMAT ./StrobeMap -n 2 -k 15 -v 1 -w 100 -c randstrobes -o tmp.tsv $genome1 $genome2 2> runtime.txt 1> stdout.txt
...
/usr/bin/time -f $TIME_FORMAT ./StrobeMap -n 2 -k 15 -v 16 -w 100 -c randstrobes -o tmp.tsv $genome1 $genome2 2> runtime.txt 1> stdout.txt
...
/usr/bin/time -f $TIME_FORMAT ./StrobeMap -n 2 -k 30 -v 31 -w 100 -c randstrobes -o tmp.tsv $genome1 $genome2 2> runtime.txt  1> stdout.txt
echo -n "StrobeMap & (2, 30, 31, 100) & " 
python genome_mapping_metrics.py tmp.tsv runtime.txt --refs $genome2



/usr/bin/time -f $TIME_FORMAT ./StrobeMap -n 3 -k 10 -v 11 -w 100 -c randstrobes -o tmp.tsv $genome1 $genome2 2> runtime.txt 1> stdout.txt
...
/usr/bin/time -f $TIME_FORMAT ./StrobeMap -n 3 -k 30 -v 31 -w 100 -c randstrobes -o tmp.tsv $genome1 $genome2 2> runtime.txt  1> stdout.txt
echo -n "StrobeMap & (3, 30, 31, 100) & " 
python genome_mapping_metrics.py tmp.tsv runtime.txt --refs $genome2


/usr/bin/time -f $TIME_FORMAT ./StrobeMap -n 2 -k 30 -v 200 -w 400 -c randstrobes -o tmp.tsv $genome1 $genome2 2> runtime.txt 1> stdout.txt
echo -n "StrobeMap & (2, 30, 200, 400) & " 
python genome_mapping_metrics.py tmp.tsv runtime.txt --refs $genome2

/usr/bin/time -f $TIME_FORMAT ./StrobeMap -n 3 -k 30 -v 200 -w 400 -c randstrobes -o tmp.tsv $genome1 $genome2 2> runtime.txt 1> stdout.txt
echo -n "StrobeMap & (3, 30, 200, 400) & " 
python genome_mapping_metrics.py tmp.tsv runtime.txt --refs $genome2

/usr/bin/time -f $TIME_FORMAT ./StrobeMap -n 2 -k 30 -v 500 -w 600 -c randstrobes -o tmp.tsv $genome1 $genome2 2> runtime.txt 1> stdout.txt
